...
for N=5:5:25
    ...
    for k=1:6
        ...
        TrainX = Normalized_Train_Features(2:4,train_indices) ; % Extracting best features: 2, 3 & 4
        ValX = Normalized_Train_Features(2:4,valid_indices) ; % Extracting best features: 2, 3 & 4
...
% Classification
N = 10 ;
TrainX = Normalized_Train_Features(2:4,:) ; % Extracting best features: 2, 3 & 4
TrainY = Train_Label ;
TestX = Normalized_Test_Features(2:4,:) ; % Extracting best features: 2, 3 & 4
TestY = Test_Label ; 
